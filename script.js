...
// --- EL ORÁCULO NUTRICIONAL (MOTOR CLÍNICO) ---
const oracleDB = [
  // DESAYUNOS (400 kcal base)
  { id: 1, tipo: 'desayuno', dietas: ['normal', 'lowcarb', 'vegetariano'], name: 'Huevos Revueltos con Palta', calBase: 400, prot: 24, carb: 10, gras: 30, desc: 'Huevos enteros, clara de huevo, palta hass y una rebanada de pan integral tostado.' },
  { id: 2, tipo: 'desayuno', dietas: ['normal', 'vegetariano'], name: 'Avena Proteica Shōgun', calBase: 400, prot: 30, carb: 55, gras: 7, desc: 'Avena tradicional, 1 scoop de proteína Whey, leche descremada y arándanos.' },
  { id: 3, tipo: 'desayuno', dietas: ['vegano'], name: 'Tofu Scramble', calBase: 400, prot: 22, carb: 20, gras: 25, desc: 'Tofu firme revuelto con cúrcuma, espinaca, aceite de oliva y pan de masa madre.' },
  { id: 4, tipo: 'desayuno', dietas: ['keto'], name: 'Huevos con Tocino', calBase: 400, prot: 25, carb: 2, gras: 32, desc: 'Huevos fritos en mantequilla, tocino crujiente y café negro.' },
  // ALMUERZOS (600 kcal base)
  { id: 5, tipo: 'almuerzo', dietas: ['normal'], name: 'Pollo y Arroz del Guerrero', calBase: 600, prot: 55, carb: 70, gras: 10, desc: 'Pechuga de pollo a la plancha, arroz blanco cocido y brócoli al vapor.' },
  { id: 6, tipo: 'almuerzo', dietas: ['normal', 'lowcarb'], name: 'Salmón Salvaje', calBase: 600, prot: 45, carb: 15, gras: 40, desc: 'Filete de salmón al horno, espárragos y ensalada verde con aceite de oliva.' },
  { id: 7, tipo: 'almuerzo', dietas: ['vegano', 'vegetariano'], name: 'Bowl de Lentejas y Quinoa', calBase: 600, prot: 35, carb: 90, gras: 12, desc: 'Guiso de lentejas, quinoa, zanahoria y semillas de zapallo.' },
  { id: 8, tipo: 'almuerzo', dietas: ['keto'], name: 'Cerdo con Palta', calBase: 600, prot: 40, carb: 5, gras: 48, desc: 'Chuleta de cerdo asada, palta entera y ensalada de hojas verdes.' },
  // CENAS (500 kcal base)
  { id: 9, tipo: 'cena', dietas: ['normal'], name: 'Atún con Papas', calBase: 500, prot: 45, carb: 55, gras: 10, desc: 'Lomo de atún a la plancha, papas cocidas y tomate en rodajas.' },
  { id: 10, tipo: 'cena', dietas: ['normal', 'lowcarb'], name: 'Carne Magra y Ensalada', calBase: 500, prot: 50, carb: 10, gras: 28, desc: 'Posta rosada o filete a la parrilla, mix verde y aceite de oliva.' },
  { id: 11, tipo: 'cena', dietas: ['vegano', 'vegetariano'], name: 'Hamburguesa de Garbanzos', calBase: 500, prot: 25, carb: 65, gras: 16, desc: 'Hamburguesa casera de garbanzos, camote al horno y ensalada.' },
  { id: 12, tipo: 'cena', dietas: ['keto'], name: 'Omelette de Queso', calBase: 500, prot: 35, carb: 4, gras: 39, desc: 'Omelette de 3 huevos con queso gauda y champiñones salteados en mantequilla.' },
  // SNACKS (300 kcal base)
  { id: 13, tipo: 'snack', dietas: ['normal', 'vegetariano', 'lowcarb'], name: 'Batido IronCore y Almendras', calBase: 300, prot: 30, carb: 10, gras: 15, desc: '1.5 scoops de Proteína IronCore en agua, más un puñado de almendras.' },
  { id: 14, tipo: 'snack', dietas: ['normal', 'vegetariano'], name: 'Yogur Griego y Plátano', calBase: 300, prot: 20, carb: 45, gras: 4, desc: 'Yogur griego natural sin azúcar y un plátano mediano picado.' },
  { id: 15, tipo: 'snack', dietas: ['vegano'], name: 'Batido de Soya y Maní', calBase: 300, prot: 25, carb: 20, gras: 13, desc: 'Proteína vegetal de soya, leche de almendras y 1 cucharada de mantequilla de maní.' },
  { id: 16, tipo: 'snack', dietas: ['keto'], name: 'Nueces y Queso', calBase: 300, prot: 15, carb: 3, gras: 25, desc: 'Mix de nueces y trozos de queso mantecoso.' }
];

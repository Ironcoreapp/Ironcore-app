...
// --- BASE DE DATOS GLOBAL (OPEN FOOD FACTS API CON CORS FIX) ---
...
document.getElementById('btn-trigger-search')?.addEventListener('click', async () => {
  ...
  try {
    // Solución del Error de Red: Agregamos CORS y Accept Headers
    ...
    c.innerHTML = `<div style="font-size:11px; color:#ff3366; text-align:center;">Error de red. Desactiva tu AdBlock o usa modo incógnito.</div>`;
  }
});
